...
const Data = {
  ...
  3: [[19, 33], {rank: 4}, "CalmGuy", '"You are still troubled by your thoughts; look a little closer"', {req: 15}, CalmGuy, {width: "60%", height: "auto", marginTop: "15px"}],  
  4: [[34, 60], {rank: 5}, "Young monk", '"Your mind grows stronger yet, little Monk, but your path does not end here"', {req: 27}, Monk, {width: "37%", height: "auto", marginTop: "15px"}],
  5: [[61, 100], {rank: 6}, "Middle Monk", '"You are wise beyond your years, but meditation always has more to teach"', {req: 40}, BuddhistMonk, {width: "55%", height: "auto", marginTop: "15px"}],
  6: [[101, 10120], {rank: 7}, "The Buddha", '"Please teach me about the art, Master"', {req: 999999}, MasterBuddha, {width: "55%", height: "auto", marginTop: "15px"}]
}
